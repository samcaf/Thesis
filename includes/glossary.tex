...
% TODO: run `makeglossaries thesis' whenever I want to redo the glossary
...
%        text=beta function,
%        description={%
%            A function describing how the effective strength of QCD scattering changes with the energy of the scattered particles.
%            %
...
%      description={
%          A phenomenological prescription for modelling non-perturbative effects, in which the effective value of \(\alpha_s\) is fixed below an appropriately chosen non-perturbative scale
%      },
%      parent=alphas
%    }
...
% DEBUG? Not showing up correctly, but may not want to include anyway
\newglossaryentry{beta-sd}
{
    name=\ensuremath{\beta_\text{SD}},
    description={
        A parameter controlling the angular dependence of the \glsxshort{sd} algorithm.
        %
...
%   name=\ensuremath{a_s},
%   description={
%   A parameterization of the strong coupling \ensuremath{a_s = }\gls{alphas}\ensuremath{/4\pi} often emerging from loop calculations.
% },
% }
...
%    description={%
%        The fraction of the jet energy that is removed by \glsxshort{rsf}.
%        %
    ...
    \newglossaryentry{splittingfn}
    {
      ...
      parent=dglap,
        ...
        \newglossaryentry{redsplitfn}
        {
          ...
          first=\vocab{reduced splitting function},
          description={
...
\newglossaryentry{distribution}
{
    ...
    \newglossaryentry{plus-fn}
    {
      ...
      text=plus-function,
      first=\vocab{plus-regularized distribution} (or plus-function),
...
\newglossaryentry{mpi}
{
  ...
  first=\vocab{multiple parton interactions} (\vocab{MPI}),
  text=MPI,
...
\newglossaryentry{pileup}
{
  ...
  description={}
    ...
    \newglossaryentry{pusubevent}
    {
      ...
      first=\vocab{pileup subtracted event},
      description={},
      parent=pileup
    }
...
\newglossaryentry{ue}
{
  ...
  first=\vocab{underlying event} (\vocab{UE}),
  text=UE,
...
\newglossaryentry{vetoalg}
{
    name=algorithm,
    text=veto algorithm,
    first=\vocab{veto algorithm},
    description={
