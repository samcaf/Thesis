...
%
If the exposition of this chapter is confusing or insufficient, I can highly recommend the pedagogical treatment of \Reff{Marzani:2019hun}.
...
%
% -- where we have already seen the use of \glslink{regularization}{\underline{regularization}} -- the removal of infinities to produce a physically sensible result.
%
...
\begin{figure}[t!]
    ...
    \caption[
        ...
        %
        Adapted from \Reff{Collins:1984xc}
        %
        \sam{complete}
    ]
    {
        ...
        %
        \sam{complete -- see page 132, fig 4.18}
    }
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{example-image-a}
    \caption{\sam{The ripple picture of angular ordering}}
    \label{fig:}
\end{figure}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{example-image-a}
    \caption{\sam{simplifications of additive observables in partonic-cascade computations}}
...
\begin{figure}[]
    ...
    \caption{
        \sam{Cartoon depicting UE and PU}
    }
