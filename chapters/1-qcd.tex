...
\begin{sourcefigure}[t!]
    ...
    % Caption
    \caption{
        Energy-weighted correlators capture correlations between high-energy structures within jets, such as particles (black lines) or subjets (purple cones), as probed by the resolved 3-point energy correlators of \Chap{ewocs} visualized by the colored disks above the jet.
        %
...
%
In \Sec{partonshower}, we discuss and roughly derive the partonic cascade model of energy flow within the quark, and of jet formation.
%
