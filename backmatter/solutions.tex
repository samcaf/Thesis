...
\begingroup
\renewcommand{\theequation}{\Aleph{chapter}.\arabic{equation}}
...
% Caption
    \caption[The basic code flow of our simple parton shower algorithm.]{The basic code flow of the parton shower algorithm described in \Prob{partonshower}.
    %
